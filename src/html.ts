export function html(
 ...
 <header><div class="eyebrow">PARETO / GITHUB COPILOT</div><h1>Find your model’s sweet spot.</h1><p>Compare benchmark quality with estimated Copilot usage. Better value is toward the upper left.</p><div class="actions"><button id="refresh">Refresh data</button><button id="key" class="secondary">Set API key</button></div></header>
 <main><section class="controls" aria-label="Comparison controls">
 ...
 <label>Billing<select id="billing"><option value="credits">AI credits</option><option value="legacy">Legacy premium requests</option></select></label>
 ...
 <label>Uncached input<input id="input" type="number" min="0" max="100000000" step="1" value="1000"></label><label>Cache read<input id="read" type="number" min="0" max="100000000" step="1" value="0"></label><label>Cache write<input id="write" type="number" min="0" max="100000000" step="1" value="0"></label><label>Output (including reasoning)<input id="output" type="number" min="0" max="100000000" step="1" value="1000"></label></div>
 ...
 <footer>Benchmarks by <a href="https://artificialanalysis.ai/">Artificial Analysis</a> · <span id="provenance">Not loaded</span><br>Copilot pricing: <a href="https://docs.github.com/en/copilot/reference/copilot-billing/models-and-pricing">GitHub Docs</a> · <span id="catalog"></span><p>Benchmark results describe the tested variant, not guaranteed performance in Copilot. Pricing updates ship with extension releases.</p></footer>
